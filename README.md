...
- NVAPI (installation instructions below)

## Setup
1. Open the `hrender.sln` file.
2. Set `hrender` as the startup project by right clicking `hrender` in the solution explorer, and selecting "Set as StartUp Project".
3. Select "ReleaseD3D12", then build the project.
4. Explanation for the UI can be found [here](./Docs/README.md).
