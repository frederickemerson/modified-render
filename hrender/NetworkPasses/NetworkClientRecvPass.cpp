...
char* NetworkClientRecvPass::clientReadBuffer = new char[VIS_TEX_LEN + REF_TEX_LEN + AO_TEX_LEN];
char* NetworkClientRecvPass::clientWriteBuffer = new char[VIS_TEX_LEN + REF_TEX_LEN + AO_TEX_LEN];
char* NetworkClientRecvPass::intermediateBuffer = new char[VIS_TEX_LEN + REF_TEX_LEN + AO_TEX_LEN];
