...
public:
    ...
    */
    ...
    /**
     *  @brief  This function is used to get the fence and fence value corresponding to 
     *  input buffer.
     */
    NV_ENC_FENCE_POINT_D3D12* GetInpFencePoint();
...
protected:
    ...
    NV_ENC_FENCE_POINT_D3D12 *m_pInputFencePt = nullptr;
    NV_ENC_FENCE_POINT_D3D12 *m_pOutputFencePt= nullptr;

    Microsoft::WRL::ComPtr<ID3D12Fence> m_pInputFence;
    Microsoft::WRL::ComPtr<ID3D12Fence> m_pOutputFence;
